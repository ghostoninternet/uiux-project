      ...
      <div className="flex flex-row w-full h-[87.5%]">
        <div className="w-[14.2857%] min-w-[260px] flex flex-col justify-between">
          <div className="w-full flex flex-col gap-10">
            <div className="w-full px-6 pt-12 space-y-8">
              <div className="w-full">
                <MenuBar link={"/dashboard"} svgIcon={<Dashboard />} darkSvgIcon={<Dashboard />} menuTitle={"Dashboard"} currentActive={currentActive} setCurrentActive={setCurrentActive}/>
              </div>
              <div className="w-full">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-3 px-6 mt-3 mb-10">
              <div>
                <HelpIcon />
              </div>
              <div className="text-2xl my-auto">
        ...
        <div className="w-[85%] bg-gray-100 rounded-tl-3xl">
            {children}
        </div>
      </div>
