function BellBlack() {
  return (
    <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="25" height="25" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlSpace="preserve">
    <g>
