        ...
        <div className="flex items-center justify-between">
            <div className="flex items-center flex-1">
                <div className="flex items-center">
                    ...
                    <div className="ml-2 w-32 overflow-hidden whitespace-nowrap text-ellipsis font-medium">{title}</div>
                </div>
            ...
            <div className="bg-[#FFF8E8] ml-2 py-2 px-1 rounded-xl w-16 text-center font-semibold">{time}</div>
        </div>
    )
}
