  ...
  return (
    <div>
        <div className="mb-7 pr-20">
            <h1 className="font-semibold text-2xl border-b-2 border-gray-200 pb-3">Change username</h1>
        ...
        <div className="mb-7 pr-20">
            <h1 className="font-semibold text-2xl border-b-2 border-gray-200 pb-3">Link account</h1>
        ...
        <div className="mb-7 pr-20">
            <h1 className="font-semibold text-2xl border-b-2 border-gray-200 pb-3">Export account data</h1>
        ...
        <div className="mb-7 pr-20">
            <h1 className="font-semibold text-2xl border-b-2 border-gray-200 pb-3 text-red-500">Delete account</h1>
