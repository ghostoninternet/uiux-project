            ...
            <div className="px-6 absolute top-[4rem] h-[calc(100vh-10rem)] overflow-y-scroll scrollbars-hidden">
                ...
                <div className="px-1 mt-5">
                    <div className="flex justify-between">
                        <div className="bg-[#FFF8E8] w-[15rem] py-3 rounded-xl text-center font-medium">Number of groups completed</div>
                        <div className="">
                            <label htmlFor="">
                ...
                <div className="px-1 mt-5">
                    <div className="flex justify-between">
                        <div className="bg-[#FFF8E8] w-[15rem] py-3 rounded-xl text-center font-medium">Number of groups</div>
                        <div className="">
                            <label htmlFor="">
                                <input type="text" className="w-20 h-[100%] bg-[#D9D9D9] rounded-lg"/>
                            </label>
                ...
                <div className="px-1 mt-5">
                    <div className="flex justify-between">
                        <div className="bg-[#FFF8E8] w-[15rem] py-3 rounded-xl text-center font-medium">Weight</div>
                        <div className="">
                            <label htmlFor="">
                                <input type="text" className="w-20 h-[100%] bg-[#D9D9D9] rounded-lg"/>
                            </label>
                ...
                <div className="flex items-center justify-end mt-10 mb-8">
                    <div className="bg-[#FABB18] flex items-center rounded-xl">
                        <div className="text-[#ffffff] font-bold text-xl px-3 py-1">Save</div>
                        <div className="pr-3"><FaSave fontSize={20} color="#ffffff" className="my-auto"/></div>
                    </div>
                </div>
            </div>
        </div>
